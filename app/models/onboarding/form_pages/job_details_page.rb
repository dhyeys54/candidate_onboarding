  ...
  module FormPages
    class JobDetailsPage < Onboarding::FormPage
      ...
      def self.validate(candidate_profile)
        candidate_profile.errors.add(:job_function, :blank) if candidate_profile.job_function.blank?
        candidate_profile.errors.add(:regions, "must have at least one selected") if candidate_profile.regions.blank?
